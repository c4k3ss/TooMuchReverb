...
REGISTER_STATIC_DSP_LIBRARIES()
{
	...
	// DLL registration removed - HISE was generating invalid code
}
...
String hise::FrontendHandler::getProjectName() { return "TooMuchReverb"; };
String hise::FrontendHandler::getCompanyName() { return "c4k3ss"; };
